...
public class EV3 {
    ...
    public final double wheelDiameter = 5.6;
    public final double wheelWidth = 2.7;
    public final double distanceBetweenWheels = 15.6;
    ...
    public EV3(RemoteEV3 remEV3) {
        colorSensor = remEV3.createSampleProvider("S4", "lejos.hardware.sensor.EV3ColorSensor", "RGB");
